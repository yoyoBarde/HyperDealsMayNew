...
class PreferedPromoAdapter(private val context: Context, private val promolist : ArrayList<PromoModel>) : RecyclerView.Adapter<PreferedPromoAdapter.ViewHolder>(){
    val database = FirebaseFirestore.getInstance()
    val TAG = "PreferredAdapter"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            PreferedPromoAdapter.ViewHolder = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.zzhomelistitem,parent,false))
...
if (promos.preferenceMatched!=0) {
    ...
    holder.containter.visibility = View.GONE
